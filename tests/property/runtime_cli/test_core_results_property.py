...
def test_tool_result_with_complex_outputs(
    ...
    assert result.stderr == stderr
    missing = object()
    assert getattr(result, "success", missing) is not missing
    assert getattr(result, "exit_code", missing) is not missing
    assert getattr(result, "operation_id", missing) is not missing
    assert getattr(result, "stdout", missing) is not missing
    assert getattr(result, "stderr", missing) is not missing
    assert getattr(result, "learning_info", missing) is not missing
