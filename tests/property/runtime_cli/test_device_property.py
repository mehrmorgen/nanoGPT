"""Property-based tests for runtime/device module."""
...
import ml_playground.framework.runtime.device as rt_device
...
def test_global_device_setup(device_type: str, dtype: str, seed: int) -> None:
    ...
    import ml_playground.framework.runtime.device as device_module
...
def test_device_function_exists() -> None:
    ...
    func = getattr(rt_device, "global_device_setup", None)
