...
class FakeSubprocessRunner:
    ...
    def __init__(self) -> None:
        ...
        self.result_factories: List[Callable[[OperationId], ToolResult]] = []
    ...
    def queue_result_factory(
        ...
        """Queue a factory for the next subprocess invocation."""
        self.result_factories.append(factory)
    ...
    def run_subprocess(
        ...
        *,
        ...
        if self.result_factories:
            factory = self.result_factories.pop(0)
