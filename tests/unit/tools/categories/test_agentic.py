...
class TestAgenticToolsInit:
    ...
    def test_init(self, agentic_tools: agentic_module.AgenticTools, config: ToolsConfig, root_path: Path) -> None:
        """Test initialization."""
...
class TestGuidelinesSetup:
    ...
    def test_guidelines_setup_with_learning_mode(
        ...
        result = agentic_tools.guidelines_setup([], learning_mode=True, verbosity_level=2)
...
class TestWorkflowHelper:
    ...
    def test_workflow_helper_with_learning_mode(
        ...
        result = agentic_tools.workflow_helper([], learning_mode=True, verbosity_level=1)
...
class TestBatchValidate:
    ...
    def test_batch_validate_standard(
        ...
        output_data = json.loads(result.stdout)
        assert output_data["validation_level"]["quality_checks"] == ["lint", "typecheck"]
...
class TestWorkflowStatus:
    ...
    def test_workflow_status_with_learning_mode(
        ...
        result = agentic_tools.workflow_status([], learning_mode=True, verbosity_level=1)
...
class TestHelperMethods:
    ...
    def test_extract_coverage_percentage(
        ...
        line_pct = agentic_tools._extract_coverage_percentage(output_with_coverage, "line")
        assert line_pct == 100.0
        
        output_no_coverage = "No coverage data"
        line_pct = agentic_tools._extract_coverage_percentage(output_no_coverage, "line")
        assert line_pct == 0.0
