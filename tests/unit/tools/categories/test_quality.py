...
class TestLint:
    ...
    def test_lint_failure(
        ...
        operation_id = OperationId(namespace="tools", category="quality", command="lint")
        expected_result = create_failure_result(operation_id, 1, "", "Lint errors found")
        subprocess_runner.set_results([expected_result])
...
class TestMypy:
    ...
    def test_mypy_success(
        ...
        expected_result = create_success_result(operation_id, "Success: no issues found")
        subprocess_runner.set_results([expected_result])
...
class TestTypecheck:
    ...
    def test_typecheck_success(
        ...
        basedpyright_id = OperationId(namespace="tools", category="quality", command="basedpyright")
        mypy_id = OperationId(namespace="tools", category="quality", command="mypy")
        
        basedpyright_result = create_success_result(basedpyright_id, "BasedPyright: No errors")
    ...
    def test_typecheck_basedpyright_failure(
        ...
        basedpyright_result = create_failure_result(basedpyright_id, 1, "", "BasedPyright errors")
        mypy_result = create_success_result(mypy_id, "Mypy: Success")
        subprocess_runner.set_results([basedpyright_result, mypy_result])
...
class TestAllChecks:
    ...
    def test_all_checks_success(
        ...
        basedpyright_id = OperationId(namespace="tools", category="quality", command="basedpyright")
        mypy_id = OperationId(namespace="tools", category="quality", command="mypy")
        deadcode_id = OperationId(namespace="tools", category="quality", command="deadcode")
        ...
        subprocess_runner.set_results([lint_result, basedpyright_result, mypy_result, deadcode_result])
