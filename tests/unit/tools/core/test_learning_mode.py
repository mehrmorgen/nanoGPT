...
from ml_playground.tools.core.interfaces import LearningInfo, ToolResult, OperationId
...
class TestLearningModeEngine:
    ...
    def test_category_best_practices(self):
        ...
        assert any("tdd" in practice.lower() or "test-driven" in practice.lower() for practice in test_practices)
    ...
    def test_educational_content_coverage(self):
        ...
        test_commands = ["unit", "integration", "e2e", "coverage-test", "coverage-report"]
