...
if TYPE_CHECKING:
    from tests.acceptance.conftest import RunCli
...
class TestLearnCommandsCLI:
    ...
    def test_learn_commands_overview_shows_all_categories(
        self, run_cli: RunCli
    ) -> None:
    ...
    def test_learn_commands_detailed_shows_full_descriptions(
        self, run_cli: RunCli
    ) -> None:
    ...
    def test_learn_best_practices_all_displays_general_practices(
        self, run_cli: RunCli
    ) -> None:
    ...
    def test_learn_commands_help_discovery_shows_subcommands(
        self, run_cli: RunCli
    ) -> None:
...
class TestLearnCommandsErrorHandling:
    ...
    def test_learn_commands_invalid_category_shows_error(self, run_cli: RunCli) -> None:
    ...
    def test_learn_explain_invalid_format_shows_error(self, run_cli: RunCli) -> None:
    ...
    def test_learn_explain_invalid_category_shows_error(self, run_cli: RunCli) -> None:
    ...
    def test_learn_explain_invalid_command_shows_error(self, run_cli: RunCli) -> None:
...
class TestLearnCommandExplanations:
    ...
    def test_learn_explain_valid_command_shows_description(
        self, run_cli: RunCli
    ) -> None:
    ...
    def test_learn_explain_test_commands_shows_testing_practices(
        self, run_cli: RunCli
    ) -> None:
...
class TestLearnCommandsIntegration:
    ...
    def test_learn_command_sync_with_cli_matches_actual_apps(
        self, run_cli: RunCli
    ) -> None:
    ...
    def test_learn_help_discovery_shows_all_subcommands(self, run_cli: RunCli) -> None:
