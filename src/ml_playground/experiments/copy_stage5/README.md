...
Curriculum Stage 5: transition from copying to legal move and winning-move prediction.

## Overview

- Dataset: deterministic legal and winning move traces for Game 15.
