...
register_extras_model("bundestag_qwen15b_lora_mps", "train", BundestagQwenTrainExtras)
register_extras_model("bundestag_qwen15b_lora_mps", "sample", BundestagQwenSampleExtras)
