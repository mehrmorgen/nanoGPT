# Copy Stage 3 (Add Start-of-Sequence Token)
...
Curriculum Stage 3: introduce explicit boundary conditioning (SOS...EOS).

## Overview

- Dataset: deterministic bounded samples with SOS and EOS markers.
