...
- [.dev-guidelines/project-specific/DOCUMENTATION.md](../../../.dev-guidelines/project-specific/DOCUMENTATION.md) – Package README standards and abstraction levels.
...
- [.dev-guidelines/project-specific/DEVELOPMENT.md](../../../.dev-guidelines/project-specific/DEVELOPMENT.md) – Coding standards, import policies, and testing expectations for core modules.
...
```bash
src/ml_playground/framework/core/
...
from ml_playground.framework.core.error_handling import safe_file_operation
...
- Follow the import standards in `.dev-guidelines/project-specific/IMPORT_GUIDELINES.md` when exposing new symbols. Prefer explicit exports in `__all__`.
