...
- [.dev-guidelines/project-specific/DOCUMENTATION.md](../../../.dev-guidelines/project-specific/DOCUMENTATION.md) – README abstraction levels, folder tree standards, and formatting rules.
